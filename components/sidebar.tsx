...
export function Sidebar({ active, onNavigate, onOpenPalette }: SidebarProps) {
  ...
  return (
    <aside className="flex flex-col h-screen sticky top-0 border-r border-[var(--border)] bg-[var(--sidebar)] px-2.5 py-3 gap-0.5 w-[216px] flex-shrink-0 overflow-y-auto">
      {/* Logo */}
      ...
      {onOpenPalette && (
        ...
        >
          <Search size={12} className="group-hover:text-[var(--gold-deep)] transition-colors" />
